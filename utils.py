...
# %% auto #0
__all__ = ['client', 'load_food_data', 'create_similarity_search_collection', 'populate_similarity_collection',
           'perform_similarity_search', 'perform_filtered_similarity_search']

# %% utils.ipynb #91b05276
import chromadb
...
def load_food_data(file_path: str) -> List[Dict]:
    ...
    try:
        ...
        print(
            f"Successfully loaded {len(food_data)} food items from {file_path}")
        return food_data
